...
import { GuestInfo } from "./WeddingDetails";
...
type GuestDetailsState = {
    ...
    addGuestRes: string;
    errorMessage: ""
    | "Please tell us your dietary restriction(s)"
    | "Please tell us your plus one's name"
...
export class GuestDetails extends Component<GuestDetailsProps, GuestDetailsState> {
    ...
    render = (): JSX.Element => {
        return <div>
            ...
            <div>
                {this.props.info.guestName}, guest of {this.props.info.whichParty},
                {this.props.info.isFamily ? "" : " not "} family
            </div>
            <div>
    ...
    doSaveClick = (_evt: MouseEvent<HTMLButtonElement>): void => {
        if (this.state.dietRes === "") {
            this.setState({ errorMessage: "Please tell us your dietary restriction(s)" })
        } else if (this.state.additional && this.state.addName === "") {
            this.setState({ errorMessage: "Please tell us your plus one's name" })
            ...
            const newInformation: GuestInfo = {
                ...
                whichParty: this.props.info.whichParty,
                additional: this.state.additional,
                addName: this.state.addName,
                isFamily: this.props.info.isFamily,
